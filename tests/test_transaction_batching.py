...
class TestTransactionNotificationBatcher:
    ...
    def test_should_batch_first_notification(self) -> None:
    ...
    def test_should_batch_within_window(self) -> None:
    ...
    def test_add_and_retrieve_batch(self) -> None:
    ...
    def test_mark_notification_sent(self) -> None:
    ...
    def test_group_transactions_by_priority(self) -> None:
    ...
    def test_should_separate_batch_mixed_priority(self) -> None:
    ...
    def test_should_not_separate_batch_same_priority(self) -> None:
    ...
    def test_should_separate_batch_too_many(self) -> None:
    ...
    def test_split_transactions_for_batching_simple(self) -> None:
    ...
    def test_split_transactions_for_batching_mixed_priority(self) -> None:
    ...
    def test_split_transactions_large_batch(self) -> None:
    ...
    def test_get_users_with_pending_batches_empty(self) -> None:
        """Test getting users with pending batches when none exist."""
        users = self.batcher.get_users_with_pending_batches()
        assert users == []

    def test_get_users_with_pending_batches_with_data(self) -> None:
