...
class TestFormatPlay:
    ...
    def test_normal_play_no_review(self):
    ...
    def test_play_level_review_upheld(self):
    ...
    def test_play_level_review_overturned(self):
        play = _make_play("Manager Challenge", "Manager challenges the call.")
    ...
    def _make_abs_pitch(self, call_desc: str, overturned: bool, challenger: str) -> dict:
        return {
            "type": "pitch",
            "isPitch": True,
    ...
    def test_abs_challenge_upheld(self):
        play = _make_play("Strikeout", "Josh Naylor strikes out swinging.")
    ...
    def test_abs_challenge_overturned(self):
    ...
    def test_abs_challenge_no_player_name(self):
    ...
    def test_non_pitch_event_with_review_ignored(self):
    ...
    def test_only_first_abs_challenge_shown(self):
