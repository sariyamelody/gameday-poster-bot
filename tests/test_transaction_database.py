...
from mariners_bot.database.models import Base, TransactionRecord, UserTransactionPreference
...
class TestTransactionRepository:
    ...
    @pytest.mark.asyncio
    async def test_save_new_transaction(self, test_db_session, sample_transaction):
    ...
    @pytest.mark.asyncio
    async def test_save_update_existing_transaction(self, test_db_session, sample_transaction):
    ...
    @pytest.mark.asyncio
    async def test_get_new_transactions(self, test_db_session, sample_transaction):
    ...
    @pytest.mark.asyncio
    async def test_get_new_transactions_excludes_notified(self, test_db_session, sample_transaction):
    ...
    @pytest.mark.asyncio
    async def test_mark_transaction_notified(self, test_db_session, sample_transaction):
    ...
    @pytest.mark.asyncio
    async def test_save_user_transaction_preferences_new(self, test_db_session, sample_preferences):
    ...
    @pytest.mark.asyncio
    async def test_save_user_transaction_preferences_update(self, test_db_session, sample_preferences):
    ...
    @pytest.mark.asyncio
    async def test_get_user_transaction_preferences_existing(self, test_db_session, sample_preferences):
    ...
    @pytest.mark.asyncio
    async def test_get_user_transaction_preferences_default(self, test_db_session):
    ...
    @pytest.mark.asyncio
    async def test_get_users_for_transaction_notification(self, test_db_session):
    ...
    @pytest.mark.asyncio
    async def test_get_users_for_transaction_notification_filtered(self, test_db_session):
    ...
    @pytest.mark.asyncio
    async def test_transaction_record_to_model_conversion(self, test_db_session, sample_transaction):
    ...
    @pytest.mark.asyncio
    async def test_user_preferences_record_to_model_conversion(self, test_db_session, sample_preferences):
